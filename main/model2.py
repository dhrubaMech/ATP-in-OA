...
hyprho0s = np.logspace(0.0,-1,10)
#hyprho0s = [1.0,0.95,0.9,0.85,0.8,0.7,0.6,0.5,0.3,0.2,0.1]
hyprho0s = [1.0,0.6,0.59,0.58,0.57,0.56,0.55,0.45,0.4,0.2,0.1]
for hyprho0 in hyprho0s:
#hyprho0 = 2.0
    print(hyprho0)
    rho = getOxygen(rho0,hyprho0)
